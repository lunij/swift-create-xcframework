...
private func makeReferenceDict(
    ...
    serializer _: PropertyListSerializer,
...
extension Xcode.HeadersBuildPhase: PropertyListSerializable {
    ...
    fileprivate func serialize(to serializer: PropertyListSerializer) throws -> [String: PropertyList] {
        ...
        // "declarations in extensions cannot override yet".
        try makeBuildPhaseDict(buildPhase: self, serializer: serializer, xcodeClassName: "PBXHeadersBuildPhase")
    }
}
...
extension Xcode.SourcesBuildPhase: PropertyListSerializable {
    ...
    fileprivate func serialize(to serializer: PropertyListSerializer) throws -> [String: PropertyList] {
        ...
        // inherited from BuildPhase, but but in Swift 3.0 we get an error that
        // "declarations in extensions cannot override yet".
        try makeBuildPhaseDict(buildPhase: self, serializer: serializer, xcodeClassName: "PBXSourcesBuildPhase")
    }
}
...
extension Xcode.FrameworksBuildPhase: PropertyListSerializable {
    ...
    fileprivate func serialize(to serializer: PropertyListSerializer) throws -> [String: PropertyList] {
        ...
        // inherited from BuildPhase, but but in Swift 3.0 we get an error that
        // "declarations in extensions cannot override yet".
        try makeBuildPhaseDict(buildPhase: self, serializer: serializer, xcodeClassName: "PBXFrameworksBuildPhase")
    }
}
...
public extension PropertyListDictionaryConvertible {
    static func asPropertyList(_ object: PropertyListDictionaryConvertible) throws -> PropertyList {
    ...
    func asPropertyList() throws -> PropertyList {
        try type(of: self).asPropertyList(self)
    }
}
...
private protocol PropertyListSerializable: AnyObject {
